...
function DashboardScreen(){
  ...
  return(
    ...
    <Text style={{fontSize: 26, fontWeight: 'bold', padding: 20}}>Hubの選択</Text>
    ...
    <View
      style={{padding: 20, position: 'absolute', bottom: '5%', right: 0}}
    >
      <Button 
