...
import { Alert, FlatList, StyleSheet, Text, View , ScrollView, RefreshControl, KeyboardAvoidingView} from 'react-native';
      ...
      [
        ...
        { text: "OK",
          onPress: async () => {
            ...
            const token = 'xoxb-1900997433024-2053652851089-M2Fjhy77d7mDuwDUo5bc6SbR'
